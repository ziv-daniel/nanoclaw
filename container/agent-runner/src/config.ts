...
export interface RunnerConfig {
  ...
  /**
   * Claude model for this agent. Defaults to claude-sonnet-4-6 if unset.
   * Override in container.json to pin a group to a specific model.
   * Per-turn model switching: the user can send /model <name> which is
