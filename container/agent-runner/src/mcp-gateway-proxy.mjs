 ...
 *
 * Bridges an MCP client (Claude agent) speaking stdio to an MCP Gateway SSE
 * endpoint. Lightweight replacement for running full MCP server processes.
 *
 * Usage (in container.json mcpServers):
 *   "command": "node",
 *   "args": ["/app/src/mcp-gateway-proxy.mjs"],
 *   "env": {
 *     "MCP_SSE_URL": "http://host.docker.internal:3001/sse",
 *     "http_proxy": "", "https_proxy": "", "HTTP_PROXY": "", "HTTPS_PROXY": ""
 *   }
 *
 * Empty proxy vars bypass the OneCLI HTTP proxy for internal gateway connections.
 */
